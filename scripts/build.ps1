...
# Builds Avro.TSF. Usage: .\build.ps1 [Debug|Release]
...
$proj = Join-Path $PSScriptRoot "..\Avro.TSF\AvroTSF.vcxproj"
...
Write-Host "Built: $(Resolve-Path (Join-Path $PSScriptRoot "..\Avro.TSF\x64\$config\AvroTSF.dll"))"
